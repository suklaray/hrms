    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-1 items-center justify-center bg-gradient-to-br from-purple-200 to-indigo-300 p-6 text-white">
        ...
        <p className="text-lg leading-relaxed max-w-full text-center text-indigo-700">
              ...
              Welcome to our company! We are passionate about building modern web applications
              that help businesses grow and thrive. Our team is dedicated to quality, innovation,
              and delivering great user experiences. Human Resource Management System (HRMS) is a software tool 
              specifically designed for the Human Resource departments of various 
              enterprises for smooth and hassle-free accomplishment of tasks related to 
              employees. This tool is effective and efficient enough which reduces the 
              time and effort of the managers. Owing to digitalisation, the new generation 
              of HR has made HRMS a crucial component. This system comprises all the 
              major systems that the human resources department is meant to do but in 
              an automatic process. <br /><br />
