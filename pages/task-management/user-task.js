...
const calculateStats = useCallback(() => {
  ...
  const getDeadlineStatus = (deadline, status) => {
    ...
    // Compare exact datetime, not just dates
    ...
    if (diffTime < 0) {
      ...
      // Due today - check remaining hours
      if (diffHours < 2) {
    ...
    const handleWorkReportSubmit = (result) => {
        // Refresh work reports after submission
        fetchUserAndTasks();
        console.log('Work report submitted:', result);
    };
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="bg-white border-b border-gray-200 px-6 py-4">
                <div className="flex justify-between items-center">
                    ...
                    {activeTab === 'tasks' && (
                        <button
                            onClick={() => setShowWorkReportModal(true)}
