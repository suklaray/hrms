...
export default function Candidates(user) {
  ...
  const handleFormMail = async (candidate) => {
    try {
      // Check if mail was already sent before
      ...
      fetchCandidates(); // refresh table after success
    } catch (error) {
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <option value="form_not_submitted">
                      Form Not Submitted
                    </option>
