...
export default function LiveTimer({ currentCheckInTime, isLoggedIn, totalHours, completedSeconds }: any) {
  ...
  const currentSessionSeconds = (currentTime.getTime() - checkIn.getTime()) / 1000;
