                            ...
                            <form onSubmit={handleLogin} className="space-y-4 lg:space-y-6">
                                ...
                                <div className="pt-6 lg:pt-8">
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="w-full text-white py-3 sm:py-2 rounded-md bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 transition duration-300 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:from-indigo-500 disabled:hover:to-purple-600"
                                    >
                                        {loading ?
