...
const PayrollCreateConfig = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        setLoading(true);
        fetch("/api/payroll/configuration", {
            method: "POST",
            headers: {
            ...
            .then(async (res) => {
                ...
                if (res.ok) {
                    toast.success(data.message || "Payroll configuration created successfully");
                    handleReset();
                    ...
                    toast.error(data.message || "Failed to create payroll configuration");
                }
            })
            .catch((err) => {
                console.error(err);
                toast.error(err.message || "Failed to create payroll configuration");
            })
            .finally(() => {
                setLoading(false);
            });
            ...
            <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
                ...
                <div className="flex-1 overflow-auto p-4 lg:p-6">
                    <Pageheader
                        ...
                        description="Fill in all required information for payroll configuration"
                        href="/dashboard"
                    />
                    {/* Payroll config form */}
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] text-[#6b7280] mt-1">
                                        Configure payroll processing rules and company payroll settings.
                                    </p>
                                </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value={form.payroll_effective_date ? (typeof form.payroll_effective_date === 'string' && /^\d{4}-\d{2}-\d{2}$/.test(form.payroll_effective_date) ? form.payroll_effective_date : new Date(form.payroll_effective_date).toISOString().split('T')[0]) : ""}
