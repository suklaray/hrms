          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
              <div
                ...
                className={`bg-white rounded-xl shadow-sm border p-4 cursor-pointer transition-all hover:shadow-md ${activeFilter === "all" ? "border-blue-500 ring-2 ring-blue-200" : "border-gray-100"
                  }`}
              >
                <div className="flex items-center justify-between">
                  <div>
              ...
              <div
                ...
                className={`bg-white rounded-xl shadow-sm border p-4 cursor-pointer transition-all hover:shadow-md ${activeFilter === "present" ? "border-green-500 ring-2 ring-green-200" : "border-gray-100"
                  }`}
              >
                <div className="flex items-center justify-between">
                  <div>
              ...
              <div
                ...
                className={`bg-white rounded-xl shadow-sm border p-4 cursor-pointer transition-all hover:shadow-md ${activeFilter === "online" ? "border-emerald-500 ring-2 ring-emerald-200" : "border-gray-100"
                  }`}
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    {Array.isArray(paginatedData) && paginatedData.length > 0 ? (
                      paginatedData.map((user, index) => (
                        <tr key={user.empid} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${user.attendance_status === "Present"
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${user.is_logged_in
                              ...
                              <div className={`w-2 h-2 rounded-full mr-1 ${user.is_logged_in ? "bg-emerald-500" : "bg-gray-400"
                                }`}></div>
