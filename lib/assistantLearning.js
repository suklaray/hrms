  ...
  const intentCategories = {
    ...
    leave: {
      keywords: [
        ...
        "without pay", "half day", "permission", "early leave"
      ],
    ...
    technical: {
      keywords: [
        ...
        "technical", "issue", "problem", "error", "bug"
      ],
      labels: ["it_support", "system_access", "hardware_request", "software_issue", "password_reset"]
    },
    ...
    facilities: {
      keywords: [
        ...
        "cleaning", "security", "access card", "id card"
      ],
      labels: ["office_facilities", "seating_arrangement", "transport_facility", "canteen_services", "maintenance_request"]
    },
    ...
    general: {
      ...
      labels: ["general_inquiry", "contact_information", "process_clarification", "help_request", "information_request"]
    }
  };
...
export async function storeQuestionResponse(question, response, userId, intent) {
  try {
    await prisma.assistant_learning.upsert({
